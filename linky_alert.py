...
LINKY_TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3NzY0MTIxMjEsImV4cCI6MTg3MDkzMzcyMSwic3ViIjpbIjA3NTY1NTU3MTYyODMwIl19.7dxrCbjjEvau9-o0dtcoUDofXdM_jaqsDjmfTLBDtOI"          # Token obtenu sur conso.boris.sh
LINKY_PRM   = "07565557162830"        # Numéro PRM (14 chiffres, sur le compteur)
...
SMTP_PASSWORD = "pivrhhblpiibomhs"  # Mot de passe d'application Gmail
